// import 'package:biz_pos/Model/item_model.dart';
// import 'package:biz_pos/Model/purchase_detail_model.dart';
// import 'package:biz_pos/Model/purchase_header_model.dart';
// import 'package:biz_pos/Model/sales_detail_model.dart';
// import 'package:biz_pos/Model/salesreturn_detail_model.dart';
// import 'package:dr_mech/models/ProductModelFile.dart';
// import 'package:dr_mech/models/SalesDetailsModel.dart';
...
//       }else if(currentItemIndex<filteredProductList.length-1){
//         this.currentItemIndex = currentItemIndex + 1 ;
//       }
//     }else if(currentItemIndex>0){
//       if(currentItemIndex<filteredProductList.length){
//         this.currentItemIndex = currentItemIndex - 1;
//       }
//     }
...
//   }
//
//   void addToPurchaseCart(ProductModel productModel,double qty){
//     if(null!= purchaseCartList && purchaseCartList.length>0){
//       final index= purchaseCartList.indexWhere((data) =>
//       data.productId.toString()==productModel.productId.toString());
//       if(index> -1  ){
//         purchaseCartList[index].qty=qty;
//         purchaseCartList[index].rate=productModel.purchaseRate;
...
//     notifyListeners();
//   }
//   void addToSalesCart(ItemModel itemModel,double qty){
...
//     notifyListeners();
//   }
//   void addToSalesReturnCart(ItemModel itemModel,double qty){
